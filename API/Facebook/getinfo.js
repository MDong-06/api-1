...
exports.index = async (req, res, next) => {
  ...
  const axios = require("axios")
axios.get(`https://graph.facebook.com/${req.query.uid}?fields=id,is_verified,cover,created_time,work,hometown,username,link,name,locale,location,about,website,birthday,gender,relationship_status,significant_other,quotes,first_name,subscribers.limit(0)&access_token=EAAD6V7os0gcBO2YkATrdPghLE6r37neB6Ma1MVhiMGZCkmxslIWrQNLAjmBRwqbgTKFyv2AhwXNjtueqNm6uYzLTjSH8CaUpE8opApKKeiq4qTq8ZAhDwZCG13ZCpSeEVkSffvsafo2buVZCqurHbEmJYiffSJoXDICN3tMItKZBSNzqpdsUOvDI2XYwZDZD`,{
        headers: {
